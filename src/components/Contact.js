...
const Contact = () => {
  ...
  return (
    <>
      <Toaster />
      <section className="text-white py-20 lg:py-[120px] overflow-hidden relative z-10">
        <div className="container pt-20">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed mb-9 text-body-color">
                  Ready to bring your ideas to life? Let's collaborate! Whether you have a specific project in mind or just want to discuss the possibilities, I'm here to turn your vision into digital reality. Reach out, and let's create something amazing together.
                </p>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-secondaryBlue rounded-lg shadow-lg sm:p-12">
                <form onSubmit={handleSubmit}>
                  ...
                  <div>
                    <button
                      type="submit"
                      className='p-2 w-3/4 grid place-items-center max-w-[220px] mx-auto rounded-full font-medium transition-all active:scale-90 bg-primary text-bg_theme'>
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="w-full rounded border-2 bg-gray-50 px-3 py-2 text-gray-800 outline-none transition duration-100"
        />
      </div>
    </>
  );
